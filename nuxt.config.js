...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        name: "description",
        content:
          "Home of the Non Fungible Ducks as well as all projects by the Duck team.",
      },
      {
        hid: "og:image",
        property: "og:image",
  ...
  plugins: ["~/plugins/breakpoint.client.js", "~/plugins/changeToast.js"],
  ...
  modules: ["@nuxtjs/axios", "@nuxtjs/toast", "@nuxt/content"],
